...
namespace JingHongLu.UI
{
    public sealed class EnemyShieldBarView : MonoBehaviour
    {
        ...
        [SerializeField] private bool hideWhenBroken = true;
        ...
        private void ResolveReferences()
        {
            ...
            if (followTarget == null && shield != null)
            {
                followTarget = shield.transform;
            }
        ...
        {
            Refresh(0f, shield != null ? shield.MaxShield : 0f);
        }
        ...
        private void Refresh()
        {
            ...
            Refresh(shield.CurrentShield, shield.MaxShield);
        }
        ...
        private void Refresh(float current, float max)
        {
            ...
            if (valueText != null)
            {
                valueText.gameObject.SetActive(showValueText && (!hideWhenBroken || hasShield));
                valueText.text = hasShield
                    ? $"{Mathf.CeilToInt(current)} / {Mathf.CeilToInt(max)}"
                    : "Break!";
            }

            SetRootActive(!hideWhenBroken || hasShield);
        }
